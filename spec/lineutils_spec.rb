...
module LineUtilsSpec
  describe LineUtils do
    ...
    describe 'divide' do
      it 'should divide correctly in a normal case' do
        divide('12345', 3).should == ['123' ,'45']
      end

      it 'should divide correctly when the size of the division is 1' do
        divide('1234', 1).should == ['1', '234']
      end

      it 'should divide correctly when there is no remainder' do
        divide('1234567890', 10).should == ['1234567890', '']
      end

      it 'should divide correctly when the word is smaller than the remainder' do
